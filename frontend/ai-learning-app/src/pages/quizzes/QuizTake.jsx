...
const QuizTake = () => {
 ...
 const handleSubmitQuiz = async () => {
  ...
  return {
    questionId,
    selectedAnswers: question.options[optionIndex],  // ← fixed
  };
});
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {currentQuestionIndex === quiz.questions.length - 1 ? (
          <button
            ...
            disabled={submitting}
            className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-500 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg"
          >
