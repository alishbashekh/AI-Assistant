...
const FlashcardSetCard = ({ flashcardSet }) => {
 ...
 return (
  <div
    className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer p-5"
...
{/* Study Button */}
      <div className="mt-6 pt-4 border-t border-slate-100">
        <button
          ...
          className="group/btn relative w-full h-11 bg-linear-to-r from-emerald-50 to-teal-50 hover:from-emerald-500 hover:to-teal-500 border border-emerald-200 hover:border-transparent text-emerald-700 hover:text-white font-semibold text-sm rounded-xl transition-all duration-200"
        >
