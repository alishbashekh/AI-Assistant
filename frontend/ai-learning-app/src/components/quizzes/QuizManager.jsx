        ...
        <form onSubmit={handleGenerateQuiz} className="space-y-4">
          <div>
            ...
            <input
              ...
              min="1"
              required
              className="w-full h-9 px-3 border border-neutral-200 rounded-lg bg-white text-sm text-neutral-900 placeholder-neutral-400 transition-colors durtion-150"
            />
          </div>
