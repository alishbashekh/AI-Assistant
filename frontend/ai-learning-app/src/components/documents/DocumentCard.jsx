  ...
  return (
   ...
   onClick={handleNavigate}>
    <div>
        ...
        <h3 className='text-base font-semibold text-slate-900 truncate mb-2' title={doc.title}>
            {doc.title}
        </h3>
        ...
        <div className="flex items-center gap-3">
            {doc.flashcardCount !== undefined && (
                <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-purple-50 rounded-lg">
                    ...
                    <span className='text-xs font-semibold text-purple-700'>{doc.flashcardCount} Flashcards</span>
                </div>
            )}
            {doc.quizCount !== undefined && (
                <div className="flex items-center gap-1.5 px-2.5 py-1.5 bg-emerald-50 rounded-lg">
                    ...
                    <span className='text-xs font-semibold text-emerald-700'>{doc.quizCount} Quizzes</span>
                </div>
            )}
        </div>
    </div>
